...
public class EnergyResult {
    ...
    public static void setAvgCo2PerKwh(int avgCo2PerKwh) {
        AVG_CO2_PER_KWH = avgCo2PerKwh;
    }
    ...
    public static int AVG_CO2_PER_KWH = 485;

    public Map<String, String> getCo2() {
        Map<String, String> map = new LinkedHashMap<>();
        String number = cumulativeEnergyMwh;
        map.put(String.format("%,d", times) + "        times", String.format("%." + 6 + "f", Double.valueOf(Double.valueOf(number) / 1000 / 1000 * AVG_CO2_PER_KWH)) + " CO2(g)");
        map.put(String.format("%,d", times * 10) + "       times", String.format("%." + 6 + "f", 10 * Double.valueOf(Double.valueOf(number) / 1000 / 1000 * AVG_CO2_PER_KWH)) + " CO2(g)");
        map.put(String.format("%,d", times * 100) + "     times", String.format("%." + 6 + "f", 100 * Double.valueOf(Double.valueOf(number) / 1000 / 1000 * AVG_CO2_PER_KWH)) + " CO2(g)");
        map.put(String.format("%,d", times * 1000) + "    times", String.format("%." + 6 + "f", 1000 * Double.valueOf(Double.valueOf(number) / 1000 / 1000 * AVG_CO2_PER_KWH)) + " CO2(g)");
        map.put(String.format("%,d", times * 10000) + "   times", String.format("%." + 6 + "f", 10000 * Double.valueOf(Double.valueOf(number) / 1000 / 1000 * AVG_CO2_PER_KWH)) + " CO2(g)");
        map.put(String.format("%,d", times * 100000) + " times", String.format("%." + 6 + "f", 100000 * Double.valueOf(Double.valueOf(number) / 1000 / 1000 * AVG_CO2_PER_KWH)) + " CO2(g)");
        return map;
    }
